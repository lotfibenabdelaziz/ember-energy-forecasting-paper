"""
src/03_modeling.py — Train/Val/Test Split + Walk-Forward Benchmarking (CLI)
==============================================================================
...
def main() -> None:
    ...
    # Guard: if train_until is ever pushed to >= val_end, val_years is empty
    # and agg_metrics() crashes on an empty groupby. Zero effect on the
    # default 2016/2020/2024 split — this only triggers for the edge case
    # already seen when experimenting with train_until >= val_end.
